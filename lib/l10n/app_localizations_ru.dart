...
class LRu extends L {
  ...
  String get emptyBody =>
      'Поделись с Wren рилсом или публикацией, и он вытащит оттуда места. Или сделай скриншот чего угодно — сообщения, страницы путеводителя — и Wren прочитает его. Названия уйдут в Карты.';
  ...
  String get emptyBodyAndroid =>
      'Поделись с Wren рилсом или публикацией, и он вытащит оттуда места. Или сделай скриншот чего угодно — сообщения, страницы путеводителя — и Wren прочитает его. Названия уйдут в приложение карт на твоём телефоне.';
  ...
  String get regionNotDetected =>
      'Нигде не сказано, где эти места. С городом поиск будет намного точнее.';
  ...
  String get importGuideSocialPost =>
      'Публикации оттуда Wren читать не умеет. Сделай скриншоты публикации и поделись ими — это работает всегда.';
